...
<div class="blockreassurance_product">
    {foreach from=$blocks item=$block key=$key}
        <div class="reassurance-item-product" {if $block['type_link'] !== $LINK_TYPE_NONE && !empty($block['link'])} style="cursor:pointer;" onclick="window.open('{$block['link']}')"{/if}>
            <div class="img-product-reassurance">
            ...
            <div class="info-reassurance-product">
